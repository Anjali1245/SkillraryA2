...
import genericUtilities.javaUtility.JavaUtility;
...
public class WebDriverUtility {
	...
	/**
	 * This method waits until element on web page is enabled to receive click
	 * 
	 * @param element
	 * @param time
	 * @return
	...
	public WebElement expliucitWait(WebElement element, long time) {
		WebDriverWait wait = new WebDriverWait(driver, time);
	...
	public void doubleClickOnElementt(WebElement element) {
		Actions action = new Actions(driver);
	...
	/**
	 * This method is used drag and drop an element to target location
	 * 
	 * @param element
	 * @param target
	 */
	...
	public void captureScreenshot(WebDriver driver, javaUtility sjutil, String className) {

		TakesScreenshot ts = (TakesScreenshot) driver;
		File src = ts.getScreenshotAs(OutputType.FILE);
		File dest = new File("./Screenshot/" + className + "_" + sjutil.getCurrentTime() + ".png");
		try {
	...
	/**
	 * This method is use to scroll till the specified element on the web page
	 * 
	 * @param element
	 */
